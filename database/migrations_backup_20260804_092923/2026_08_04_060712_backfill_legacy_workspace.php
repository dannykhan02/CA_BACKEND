// database/migrations/2026_08_04_000005_backfill_legacy_workspace.php
<?php
...
return new class extends Migration
{
            ...
            User::query()->chunkById(200, function ($users) use ($legacyWorkspaceId) {
                foreach ($users as $user) {
                    DB::table('workspace_members')->insert([
                        ...
                        'user_id' => $user->id,
                        'role' => $user->role, // preserves existing role exactly
                        'joined_at' => now(),
                        'created_at' => now(),
                        'updated_at' => now(),
                    ]);
    ...
    {
        // Deliberately irreversible — unwinding individual memberships isn't
        // a clean inverse. Use migrate:reset in dev if you need to undo this.
    }
};
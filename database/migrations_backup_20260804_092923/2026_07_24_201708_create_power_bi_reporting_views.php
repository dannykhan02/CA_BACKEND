...
{
    /**
     * Power BI never touches live app tables directly — it connects only
     * to these two views. Both hard-exclude Restricted documents regardless
     * of any future auto_extract_classifications config change, since a BI
     * dashboard is a much broader-audience surface than the app's own
     * per-user classification policy. This is a deliberate, separate
     * decision from the extraction gate — see docs/DECISIONS.md.
     */
